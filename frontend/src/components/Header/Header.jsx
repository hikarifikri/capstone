...
import userImg from "../../assets/images/hero-img03.png";
            ...
            <div className="container">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link to='/login'>
                            <button className="bg-primaryColor py-2 px-6 text-white font-[600] h-[44px] flex items-center juistify-center rounded-[500px]">
                                Login
                            </button>
                        </Link>
